 ...
 */
package de.muenchen.digiwf.bpm.server.configuration;

import de.muenchen.allgemein.nfcconverter.NfcRequestFilter;
...
public class UnicodeConfiguration {
    ...
    public FilterRegistrationBean<NfcRequestFilter> nfcRequestFilterRegistration() {
        ...
        registration.setFilter(this.nfcRequestFilter());
