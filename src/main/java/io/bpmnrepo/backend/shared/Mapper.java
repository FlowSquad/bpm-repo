...
import io.bpmnrepo.backend.assignment.domain.Assignment;
import io.bpmnrepo.backend.diagram.domain.BpmnDiagram;
import io.bpmnrepo.backend.version.domain.BpmnDiagramVersion;
import io.bpmnrepo.backend.repository.domain.BpmnRepository;
...
import io.bpmnrepo.backend.user.api.UserTO;
import io.bpmnrepo.backend.user.infrastructure.UserEntity;
